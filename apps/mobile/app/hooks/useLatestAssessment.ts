...
import { getAssessment } from '@lifesync/api-sdk';
    ...
    try {
      ...
      if (assessmentId) {
        try {
          ...
          console.log('📊 MOBILE DEBUG - Assessment Data from Backend:', JSON.stringify(assessmentData, null, 2));
          console.log('📊 MOBILE DEBUG - Traits:', assessmentData.traits);
