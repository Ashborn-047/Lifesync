...
// Hardcode production URL for reliability during testing
// export const API_URL = "https://lifesync-production.up.railway.app";

import { Platform } from 'react-native';

// Use local backend for debugging
// Android Emulator needs 10.0.2.2, Web/iOS needs localhost
const LOCAL_BACKEND = Platform.OS === 'android' ? 'http://10.0.2.2:8000' : 'http://localhost:8000';
export const API_URL = LOCAL_BACKEND;
