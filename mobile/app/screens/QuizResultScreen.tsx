...
import { generateExplanation, getAssessment } from '../lib/api';
import type { ExplanationResponse, AssessmentResult } from '../types';
      ...
      try {
        ...
        router.push({
          ...
          params: {
            ...
            traits: JSON.stringify(assessment.traits),
            facets: JSON.stringify(assessment.facets),
            hasCompleteProfile: assessment.has_complete_profile ? 'true' : 'false',
            // Explanation data
            summary: explanation.summary || explanation.vibe_summary || '',
            personaTitle: explanation.persona_title || '',
            strengths: JSON.stringify(explanation.strengths || []),
            growthEdges: JSON.stringify(explanation.growth_edges || []),
            howYouShowUp: explanation.how_you_show_up || '',
            tagline: explanation.tagline || '',
            steps: JSON.stringify(explanation.steps || []),
